...
<div class="sadmin-main-dash">
    ...
    <div class="sadmin-panel-rhtside">
        ...
        <div class="dashbox">
            <div class="sadmin-study-con">
                <div class="sadmin-youtube-study">
                    <iframe width="560" height="315"
                        src="https://www.youtube.com/embed/iDj-QfXd0e4?si=Cgn9QARmHUPIVcFh"
                        title="YouTube video player" frameborder="100"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                        referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
                <div class="sadmin-youtube-study"></div>
            </div>
        </div>
    </div>
</div>
