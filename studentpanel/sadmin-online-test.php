...
<div class="sadmin-main-dash">
    ...
    <div class="sadmin-panel-rhtside">
        ...
        <div class="dashbox">
            <div class="sadmin-table-container">
                <table class="sadmin-table">
                    ...
                    <tbody>
                        <tr>
                            <td class="sadmin-strong">Test</td>
                            <td>No. of Qns.: 2</td>
                            <td>Duration: 33 Min</td>
                            <td class="sadmin-strong">POST GRADUATE IN DIPLOMA IN COMPUTER APPLICATION</td>
                            <td><span class="sadmin-active-status">Active On 2024-02-10 13:19 to 16:19</span></td>
                        </tr>
                    </tbody>
                </table>
            </div>
