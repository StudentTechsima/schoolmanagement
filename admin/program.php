    ...
    <div class="admin-dashboard-header">
        ...
        <div class="admin-headerRight-header-left">
            ...
            <div class="admin-headerRight-logo">
                <img src="/schoolmanagement/admin/images/adminLogo.png" alt="certificate_image" id="admin-profileImage">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="admin-program-tableData" colspan="3">
                                            <img src="/schoolmanagement/admin/images/adminLogo.png" alt="Certificate_image" class="admin-program-img">
                                        </td>
                                        <td class="admin-program-tableData">
                                            Basic Courses
                                        </td>
                                        ...
                                        <td class="admin-program-tableData">
                                            <div class="admin-program-actionLink">
                                                <a href="programUpdateform.php" class="admin-program-actionLink">
